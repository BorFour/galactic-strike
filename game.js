...
var eurecaClientSetup = function() {
	...
	eurecaClient.ready(function (proxy) {		
		eurecaServer = proxy;
        console.log("Eureca server:" + eurecaServer);
	});
	...
	eurecaClient.exports.spawnEnemy = function(i, x, y)
	{
		...
		console.log('SPAWN');
		var charr = new Character(i, x, y, game, myCharacter);
		charactersList[i] = charr;
        game.spacePhysics.addDynamic(charr.character);
	}
...
//			charactersList[id].turret.rotation = state.rot;
...
window.onload = function() {	
	 game = new Phaser.Game(750, 800, Phaser.AUTO, "");
